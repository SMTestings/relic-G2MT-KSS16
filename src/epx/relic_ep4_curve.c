...
#if defined(EP_ENDOM) && FP_PRIME == 329
/** @{ */
#define K16_P329_A0		"0"
#define K16_P329_A1		"0"
#define K16_P329_A2		"6"
#define K16_P329_A3		"0"
#define K16_P329_B0		"0"
#define K16_P329_B1		"0"
#define K16_P329_B2		"0"
#define K16_P329_B3		"0"
#define K16_P329_X0		"126C32DFBB97BA2BE06CC4F6EA294ABC3CB8FD2C85994AFF48F396F3F4D0984446B7FC8706A5E1E31D4"
#define K16_P329_X1		"C053B072FD5F650167FE7A3B59DF18F12D06D4231C5878D533103B95FF065E78836DD9D7F5D299A3E8"
#define K16_P329_X2		"3DA29B6F7A586791783C975A8838DFD850660CD24D10411FFEB181154E5A8A662E2C483EB49F0048B1"
#define K16_P329_X3		"127B48E0AA5AB72E5FDDA073E9169F02AC70BA5280E290F1D348FF72B1CCC8258BA2FA9703861D5477B"
#define K16_P329_Y0		"1104BAC78C1FFD28EDCBD438A7227B8E062095A9845476C142D673E4C69B5DA37D2BDFBE520D9425AEB"
#define K16_P329_Y1		"111FAFF596492AEFCFAEE9A66D642B39EB13348F20D2305B6A278F167B62175095131D58EB821E97571"
#define K16_P329_Y2		"5BE7A9124FF20EF6D45FBC22B64C43C376BE65D8705AE07D77E03040DDAFE10208C30C3F99D519E902"
#define K16_P329_Y3		"897BF4EEEAFB1570B24AA0303A498D948814B104EE9BC61D1E7940A241F91184DFFD6A71C2D9B9222D"
#define K16_P329_R		"6C1F4343BF9DD2C640095CE69C392889FB62EE11626438DE8253623ED8180001"
#define K16_P329_H		""
/** @} */
#endif
	...
	if (ep4_curve_is_twist() == RLC_EP_MTYPE) {
		switch (ctx->ep_opt_a) {
			...
			default:
				...
				for(int i=0;i<2;i++) for(int j=0;j<2;j++) fp_mul(c[i][j], a[i][j], ctx->ep_a);
				break;
		}
		fp4_mul_art(c, c);
	} else {
