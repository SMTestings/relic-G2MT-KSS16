...
#elif FP_PRIME == 315 || FP_PRIME == 317 || FP_PRIME == 329 || FP_PRIME == 330 || FP_PRIME == 509 || FP_PRIME == 765 || FP_PRIME == 766
...
#elif FP_PRIME == 329 || FP_PRIME == 330 || FP_PRIME == 765 || FP_PRIME == 766
...
/**
 * Checks if an element form G_2 is valid (has the right order) 
 * using a new method on curve kss16.
 *
 * @param[in] a             - the element to check.
 */
int g2_is_valid_kss16(const g2_t a);
